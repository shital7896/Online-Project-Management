...
const SideBar = ({ src1, src2, src3, prop1, prop2, prop3, prop4, prop5, prop6 }) => {
    return (
        <Box width={{sm:"0px",md:"15%",base:"0px",lg:"6%",xl:"6%"}} display={'flex'} backgroundColor={'white'} flexDirection={'column'} justifyContent={'center'} alignItems={'center'} height={"100vh"} boxShadow={'rgba(0, 0, 0, 0.1) 0px 0px 5px 0px, rgba(0, 0, 0, 0.1) 0px 0px 1px 0px'} position="fixed">

...
const InsertProject = () => {
  ...
  const [touched, setTouched] = useState(false); // New state to track interaction
    ...
    >
      {screenSize.width > 640 ? (
        <SideBar
          ...
          prop6={"20px"}
          src1={"/images/Dashboard.jpg"}
          src2={"/images/Project-list.jpg"}
          src3={"/images/create-project-active.jpg"}
        />
      ) : null}
      <Box ml={{ md: "15%", lg: "6%", xl: "6%" }} mb={"80px"}>
        ...
        <Box
          ...
          m={"auto"}
          ml={{ base: "10px", sm: "20px", md: "30px", lg: "10px", xl: "10px" }}
              ...
              <Box>
                ...
                <Box>
                  <Input
                    ...
                    onChange={(e) => handleChange(e)}
                  />
                  {touched && formData.start_date === "" && (
            <Text color={"red"}>Start Date Required</Text>
          )}
                </Box>
              </Box>
              <Box>
                ...
                <Box>
                  <Input
                    ...
                    onChange={(e) => handleChange(e)}
                  />
                  {touched && formData.end_date === "" && (
            <Text color={"red"}>End Date Required</Text>
          )}
          {touched && error !== "" && (
